const DEFAULT_RESULT_LIMIT = Infinity;
...
export function searchWords({ words, rawQuery, category, offset = 0, limit = DEFAULT_RESULT_LIMIT }) {
...
export function filterWords({ words, rawQuery, category, limit = DEFAULT_RESULT_LIMIT }) {
