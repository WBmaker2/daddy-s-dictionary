...
export async function loadDictionaryData({ files, loadFile, onOptionalError }) {
  ...
  const [baseDictionary, supplementalDictionary, textbookExpressionsDictionary, examplePayload] =
    await Promise.all([
      loadManifestEntry(base, loadFile, onOptionalError),
      loadManifestEntry(supplemental, loadFile, onOptionalError),
      loadManifestEntry(textbookExpressions, loadFile, onOptionalError),
      loadManifestEntry(exampleSentences, loadFile, onOptionalError)
    ]);
